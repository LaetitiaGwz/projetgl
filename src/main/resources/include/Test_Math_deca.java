...
public class Test_Math_deca{
	...
	public static void main(String args[]){
		...
		nbErreur=0;
		nb=0;
		for(float x = (float)0; x < (float)Math.PI  ;x = x + (float) Math.pow(2,-10)){
		...
		// nbErreur=0;
		// nb=0;
		// for(float x = -(float)Math.PI/2 ; x < (float)Math.PI/2 ; x = x + (float) Math.pow(2,-13)){

		// 	diffRelative = Math.abs(((float)Math.sin(x) - Math_deca.cosTaylor(x))/(float)Math.cos(x));
		// 	diff =Math.abs(((float)Math.cos(x) - Math_deca.cosTaylor(x)));
		// 	nb ++ ;
		// 	//if ( diffRelative >= Math.pow(10,-3)) {
		// 	if ( diff > (float)Math.ulp((float)Math.cos(x)) && Float.isNaN(Math.ulp((float)Math.cos(x)))){
		// 		System.out.println("Erreur pour x="+x);
		// 		System.out.println("Math_deca.cossTaylor : "+Math_deca.cosTaylor(x));
		// 		System.out.println("Math.cos : "+(float)Math.cos(x));
		...
		System.out.println("test de arctan en dse :\n");
                nbErreur=0;
                nb=0;
            for(float x = 0.99F ; x < 1.F ; x = x + (float) Math.pow(2,-13)){
		//	//diffRelative = Math.abs(((float)Math.atan(x) - Math_deca.atan(x))/(float)Math.asin(x));
			...
			if ( diff > Math_deca.ulp((float)Math.atan(x))){
				System.out.println("Erreur pour x="+x);
				System.out.println("Math_deca.atan : "+Math_deca.atan(x));
				System.out.println("Math.atan : "+Math.atan(x));
