...
public class Test_Math_deca{
	...
	public static void main(String args[]){
		...
		// for (float x = 1000000 ; x< 1010000; x = x + (float) Math.pow(2,-4)){ 
		...
		// 		diffMean += diff/Math_deca.ulp((float)Math.ulp(x));
		...
		// }
		// diffMean /=nbErreur ;
		// System.out.println(ANSI_GREEN+"fin du test de ulp. Erreur rencontré : "
		...
		// 		diffMean += diff/Math_deca.ulp((float)Math.tan(x));
		...
		// 	" tests. \n" + "moyenne erreur : " + diffMean + ANSI_RESET);
		...
		// diffMax = 0 ;
		// diff = 0 ;
		// for(float x = 0; x < (float)Math.PI*2; x = x + (float) Math.pow(2,-17)){
		...
		diffMean = 0 ;
		diffMax = 0 ;
		// System.out.println("X=[0:2^(-10):2*pi];");
		// System.out.print("Y=[");
		// for(float x = 0; x < Math.PI*2 ;x += Math.pow(2,-10)){
		...
		// 	nb ++ ;
		// 	System.out.print(diff/Math_deca.ulp((float)Math.sin(x))+",");
		...
		// System.out.println("scatter(X,Y,[],Y+5);");
		// diffMean/=(nbErreur);
		...
		// diffMax = 0 ;
		// diffMean = 0 ;
		// System.out.println("X=[0:2^(-2):1000];");
		// System.out.print("Y=[");
		// for(float x = 0; x < 1000 ;x += Math.pow(2,-2)){
		...
		// 	nb ++ ;
		// 	System.out.print(diff/Math_deca.ulp((float)Math.cos(x))+",");
		...
		// diffMax = 0 ;
		// diffMean = 0 ;
		// System.out.println("X=[0:2^(-10):1];");
		// System.out.print("Y=[");
		// for(float x = 0; x < 1f ; x = x + (float) Math.pow(2,-10)){
		...
		// 	nb ++ ;
		// 	System.out.print(diff/Math_deca.ulp((float)Math.asin(x))+",");
		...
		// diffMax = 0 ;
		// diffMean = 0 ;
		System.out.println("X=[0:2^(-3):1];");
		System.out.print("Y=[");
		for(float x = 0; x < 1 ; x = x + (float) Math.pow(2,-3)){
			...
			diff =Math.abs(((float)Math.atan(x) - Math_deca.atan(x)));
			nb ++ ;
			System.out.print(diff/Math_deca.ulp((float)Math.atan(x))+",");
